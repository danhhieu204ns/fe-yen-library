...
function ImportModal({
    ...
    const uploadToServer = async () => {
        ...
        let res = await absentService.importAbsentStudent(body);
        console.log(res);
        setUploading(false);
    ...
    const generateTemplate = () => {
        let cols = ["Mã sinh viên", "Họ tên", "Lý do", "Mã môn học", "Ngày vắng", "Số tiết vắng"]
        exportExcelFromJson([{}], cols, "mau_sinh_vien_vang.xlsx")
    }
