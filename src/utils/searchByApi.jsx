...
export function getColumnSearchProps(title, dataIndex){
    ...
    const handleSearch = async (selectedKeys, confirm, dataIndex) => {
        ...
        // let body = {}
        // body[dataIndex] = selectedKeys[0] // Direct object declaration will skip array key value and value will be an array
        // let res = await searchApi(body);
        // console.log(res)
        // setData(res);
        confirm();
    };
        ...
        filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters, close }) => (
            ...
            <RangePicker
                ...
                onChange={(date, dateString) => {
                    setSelectedKeys(dateString ? dateString.map((entry) => dayjs(entry, 'DD/MM/YYYY').format('YYYY-MM-DD')) : [])
